...
<script type="text/javascript">
	const noticeList = () => {
		location.href = "/notice/noticeList.pj1?";
	}
	const noticeDelete = () => {
...
1. request객첵에 조회결과를 담았나? - req.setAttribute("nList", nList); - 어디에? -> 화면이 나가기 전에 
   -> 컨트롤러 계층에서 결정할 일이다 - MVC -> 컨트롤 계층은 사용자가 입력한 값을 넘겨준다, 컨트롤 계층은 응답페이지를 결정해줌 
   -> 컨트롤 계층에서 기능을 처리하지 않는다. - 기능은 모델계층에게 맡기자
2.   
-->
